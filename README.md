About dist_s1_enumerator-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dist_s1_enumerator-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dist_s1_enumerator-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dist_s1_enumerator
# for installing globally
pixi global install dist_s1_enumerator
```
...
It is possible to list all of the versions of `dist_s1_enumerator` available on your platform:
...
```
pixi search dist_s1_enumerator --channel conda-forge
```
